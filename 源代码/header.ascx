...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">体育比赛网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Player/frontlist.aspx">球员</a></li>
                <li><a href="<%=basePath %>Team/frontlist.aspx">球队</a></li>
                <li><a href="<%=basePath %>Schedule/frontlist.aspx">赛程</a></li>
                <li><a href="<%=basePath %>Player/frontlist2.aspx">推荐巨星</a></li>
                <li><a href="<%=basePath %>Video/frontlist.aspx">视频集锦</a></li>
                <li><a href="<%=basePath %>Record/frontlist.aspx">数据统计</a></li>
                <li><a href="<%=basePath %>News/frontlist.aspx?newsTypeObj=1">评论专区</a></li>
                <li><a href="<%=basePath %>News/frontlist.aspx?newsTypeObj=2">专家寄语</a></li>
                <!--
                <li><a href="<%=basePath %>NewsComment/frontlist.aspx">资讯评论</a></li>
                <li><a href="<%=basePath %>UserInfo/frontlist.aspx">用户</a></li>
                <li><a href="<%=basePath %>NewsType/frontlist.aspx">资讯类别</a></li>
                -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <!--
                        <li><a href="<%=basePath %>index.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布信息</a></li>
                        <li><a href="<%=basePath %>index.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的收藏</a></li>
                        -->
                        <li><a href="<%=basePath %>NewsComment/userFrontList.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的评论</a></li>
