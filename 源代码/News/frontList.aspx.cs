...
using System.Data;
public partial class News_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?title=" + title.Text.Trim()  + "&&newsTypeObj=" + newsTypeObj.SelectedValue.Trim()+ "&&showFlag=" + showFlag.Text.Trim()+ "&&publishDate=" + publishDate.Text.Trim());
        }
