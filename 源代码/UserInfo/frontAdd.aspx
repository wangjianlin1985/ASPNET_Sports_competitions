<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontAdd.aspx.cs" Inherits="UserInfo_frontAdd" %>
...
<uc:header ID="header" runat="server" />
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontList.aspx">用户管理</a></li>
...
var basePath = "<%=basePath%>";
	...
	function ajaxUserInfoAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "UserInfo/UserInfoController.aspx?action=add",
			dataType : "json" , 
