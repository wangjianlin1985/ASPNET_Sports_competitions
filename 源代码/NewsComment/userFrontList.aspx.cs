...
using System.Data;
public partial class NewsComment_frontList : System.Web.UI.Page
{
    ...
    private void BindnewsObj()
    {
        ...
        for (int i = 0; i < newsObjDs.Tables[0].Rows.Count; i++)
        {
            ...
            li = new ListItem(dr["title"].ToString(),dr["newsId"].ToString());
            newsObj.Items.Add(li);
        }
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("userFrontList.aspx?newsObj=" + newsObj.SelectedValue.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&commentTime=" + commentTime.Text.Trim());
        }
