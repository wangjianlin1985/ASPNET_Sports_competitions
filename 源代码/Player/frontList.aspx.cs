...
public partial class Player_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?playerName=" + playerName.Text.Trim()  + "&&teamObj=" + teamObj.SelectedValue.Trim()+ "&&superStarFlag=" + superStarFlag.Text.Trim()+ "&&addTime=" + addTime.Text.Trim());
        }
