...
using System.Data;
public partial class Team_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?teamName=" + teamName.Text.Trim() + "&&contestArea=" + contestArea.Text.Trim()+ "&&bornDate=" + bornDate.Text.Trim());
        }
